    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      >
        <div className="flex items-start justify-between gap-2">
          {!collapsed && (
            <div>
              <p className="text-xs font-semibold" style={{ color: SIDEBAR_LABEL }}>
                {getGreeting()},
              </p>
          ...
          <button
            ...
            style={{ color: SIDEBAR_INACTIVE, marginLeft: collapsed ? 'auto' : '0' }}
          >
          ...
          >
            {[
              ...
              <button
                ...
                style={{
                  backgroundColor: darkMode === value ? 'rgba(255,255,255,0.15)' : 'transparent',
      ...
      {profileOpen && !collapsed && (
        <div
          className="card p-5 mx-3 mb-2 rounded-xl overflow-hidden"
        >
        ...
        >
          <img
            ...
            onError={(e) => {
              ...
              e.target.src = 'https://ui-avatars.com/api/?name=Jaya+Dubey&background=059669&color=fff&size=64&bold=true&rounded=true';
            }}
          />
          {!collapsed && (
            <>
              <div className="min-w-0 flex-1 text-left">
                ...
                <p className="text-xs font-medium" style={{ color: SIDEBAR_LABEL }}>
                  {role === 'admin' ? 'Admin Manager' : 'Viewer'}
                </p>
              </div>
              {profileOpen
                ? <ChevronUp size={13} style={{ color: SIDEBAR_LABEL, flexShrink: 0 }} />
                : <ChevronDown size={13} style={{ color: SIDEBAR_LABEL, flexShrink: 0 }} />
              }
            </>
          )}
        </button>
